    ...
    switch (FFBPacketHandler.PacketType.ToString())
    {
      case "PT_CONDREP":
        if (this.Joystick.Ffb_h_Eff_Cond(data, ref FFBPacketHandler.ConditionalReport) == 0U)
        {
          ...
          if (Utils.CompareObjects((object) FFBPacketHandler.OldConditionalReport, (object) FFBPacketHandler.ConditionalReport))
            return;
      ...
      case "PT_CONSTREP":
        if (this.Joystick.Ffb_h_Eff_Constant(data, ref FFBPacketHandler.ConstantForceReport) == 0U)
        {
          ...
          if (Utils.CompareObjects((object) FFBPacketHandler.OldConstantForceReport, (object) FFBPacketHandler.ConstantForceReport))
            return;
      ...
      case "PT_EFFREP":
        if (this.Joystick.Ffb_h_Eff_Report(data, ref FFBPacketHandler.EffectReport) == 0U)
        {
          ...
          if (Utils.CompareObjects((object) FFBPacketHandler.OldEffectReport, (object) FFBPacketHandler.EffectReport))
            return;
      ...
      case "PT_ENVREP":
        if (this.Joystick.Ffb_h_Eff_Envlp(data, ref FFBPacketHandler.EnvelopeReport) == 0U)
        {
          ...
          if (Utils.CompareObjects((object) FFBPacketHandler.OldEnvelopeReport, (object) FFBPacketHandler.EnvelopeReport))
            return;
      ...
      case "PT_PRIDREP":
        if (this.Joystick.Ffb_h_Eff_Period(data, ref FFBPacketHandler.PeriodicReport) == 0U)
        {
          ...
          if (Utils.CompareObjects((object) FFBPacketHandler.OldPeriodicReport, (object) FFBPacketHandler.PeriodicReport))
            return;
      ...
      case "PT_RAMPREP":
        if (this.Joystick.Ffb_h_Eff_Ramp(data, ref FFBPacketHandler.RampForceReport) == 0U)
        {
          ...
          if (Utils.CompareObjects((object) FFBPacketHandler.OldRampForceReport, (object) FFBPacketHandler.RampForceReport))
            return;
